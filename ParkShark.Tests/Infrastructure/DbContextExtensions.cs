...
namespace ParkShark.Tests.Infrastructure
{
    /// <summary>
    /// These extensions make sure that the generated Entity Ids are reset to 1 when requesting a new DB Context using the InMemory Provider
    /// </summary>
